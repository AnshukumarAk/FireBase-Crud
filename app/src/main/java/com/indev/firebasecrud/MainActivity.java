package com.indev.firebasecrud;
...
import com.indev.firebasecrud.databinding.ActivityLoginPageBinding;
import com.indev.firebasecrud.databinding.ActivityMainBinding;
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!pwd.equals(cnfPwd)) {
                    Toast.makeText(MainActivity.this, "Please check both having same password..", Toast.LENGTH_SHORT).show();
